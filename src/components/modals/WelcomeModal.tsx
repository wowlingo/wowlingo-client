...
export default function WelcomeModal({ isOpen, onConfirm, onClose, username = '' }: WelcomeModalProps) {
  ...
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-full z-[100] flex flex-col h-full w-full bg-black">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full px-8">
        ...
        {/* 이미지 영역 */}
        <div className="relative mb-8 mt-20 flex items-center justify-center">
